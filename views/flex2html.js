...
function flex2html_right(element, json) {
...
function bubble_struc_text(json) {
    ...
    return `<div class="lyItem Ly${size}"><div class="T1 fx${direction.toUpperCase()} msg-box-${custom}" dir="${direction}"><!-- hero --><!-- header --><!-- body --><!-- footer --></div></div>`
}
